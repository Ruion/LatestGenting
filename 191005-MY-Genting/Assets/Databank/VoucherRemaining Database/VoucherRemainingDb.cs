...
namespace DataBank
{
    public class VoucherRemainingDb : SqliteHelper
    {
        private const String CodistanTag = "Codistan: VoucherRemainingDb:\t";

        private const String TABLE_NAME = "Voucher_Balance_Summary";
        ...
        public VoucherRemainingDb() : base()
        {
        ...
        public void addData(VoucherRemainingEntity location)
        {
            IDbCommand dbcmd = getDbCommand();
            dbcmd.CommandText =
        ...
        public void updateData(VoucherRemainingEntity location)
        {
