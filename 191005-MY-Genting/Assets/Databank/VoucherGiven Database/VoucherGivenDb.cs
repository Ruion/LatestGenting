...
namespace DataBank
{
    public class VoucherGivenDb : SqliteHelper
    {
        private const String CodistanTag = "Codistan: VoucherGivenDb:\t";
        ...
        public void addData(VoucherGivenEntity location)
        {
            IDbCommand dbcmd = getDbCommand();
            dbcmd.CommandText =
        ...
        public void updateData(VoucherGivenEntity location)
        {
